...
The final accuracy of the model is 82.14% means the model can use to predict if the customer will buy again, It will return 1 or 0: 1 means a customer will buy again from the Audiobook company and 0 means they won't buy again.
